...
/////////change today
        ...
        this.isValidDemand = this.isValidContribution = function (n) {
            return false !== JSUS.isInt(n, 0, COINS); //it was COINS before
        };
        ...
        this.checkInputs = function () {
            ...
            if (!node.game.isValidContribution(contrib)) {
                ...
                errorC.innerHTML = 'Invalid contribution. ' +
                    'Please enter a number between 0 and ' + COINS; //it was COINS before
...
//                }
            ...
            save = COINS - node.game.oldContrib; //it was COINS  - node.game.oldContrib before
        ...
        this.displaySummaryPrevRound = function () {
            ...
            if ('number' === typeof node.game.oldContrib) {
                ...
                save = COINS - node.game.oldContrib;  //it was COINS before
